...
export const annotationsGet = new Set(["categoryId","id"]) as ReadonlySet<string>;

/** annotations.set item params */
export const annotationsSet = new Set(["annotations","id"]) as ReadonlySet<string>;

/** annotations.add item params */
export const annotationsAdd = new Set(["categoryId","id","label","labelMarkdown","properties"]) as ReadonlySet<string>;

/** annotations.remove item params */
export const annotationsRemove = new Set(["id","index"]) as ReadonlySet<string>;
