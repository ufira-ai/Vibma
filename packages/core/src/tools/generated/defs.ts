...
export const tools: ToolDef[] = [
      ...
      if (m === "create") {
        const schemas: Record<string, z.ZodTypeAny> = {
          "component": z.object({
            ...
            cornerRadiusVariableName: z.string().optional().describe("Bind FLOAT variable to corner radius by name"),
      ...
      if (m === "create") {
        const schemas: Record<string, z.ZodTypeAny> = {
          "frame": z.object({
            ...
            opacityVariableName: z.string().optional().describe("Bind FLOAT variable to opacity by name"),
          ...
          "auto_layout": z.object({
            ...
            itemSpacingVariableName: z.string().optional().describe("Bind FLOAT variable to item spacing by name"),
  ...
  },
  {
    ...
    schema: (caps) => filterMethodsByTier({    method: z.enum(["get", "update", "help"]),
    ...
    topic: z.string().optional().describe("Help topic — method name for endpoint help, e.g. \"create\""),
    }, caps, {"get":"read","update":"read","help":"read"}),
    tier: "read" as const,
    validate: (params: any) => {
      const m = params.method;
      if (m === "update") {
