...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    factor: z.coerce.number().optional().describe("Scale factor, >= 0.01. 0.5 = 50%, 2 = 200%. Scales children, text, strokes, effects, and layout geometry from the node's top-left."),
