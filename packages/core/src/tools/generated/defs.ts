    ...
    validate: (params: any) => {
      ...
      if (m === "update") {
        const itemSchema = z.object({
          ...
          scopes: flexJson(z.array(z.string())).optional().describe("Restrict where variable can be applied. FLOAT: CORNER_RADIUS, GAP, STROKE_FLOAT, WIDTH_HEIGHT, OPACITY. COLOR: ALL_FILLS, FRAME_FILL, SHAPE_FILL, TEXT_FILL, STROKE_COLOR. Default: ALL_SCOPES."),
