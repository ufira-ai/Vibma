...
export const tools: ToolDef[] = [
      ...
      if (m === "create") {
        const schemas: Record<string, z.ZodTypeAny> = {
          "frame": z.object({
            ...
            strokeColor: S.colorRgba.optional().describe("Stroke color (auto-binds to matching variable/style)"),
            strokeStyleName: z.string().optional().describe("Paint style name for stroke"),
            strokeVariableName: z.string().optional().describe("Color variable by name e.g. 'border/default'"),
          ...
          "line": z.object({
            ...
            strokeVariableName: z.string().optional().describe("Color variable by name for stroke"),
            strokeWeight: z.coerce.number().optional().describe("Line thickness (default: 1)"),
            opacity: z.coerce.number().optional(),
          }),
          "group": z.object({
  ...
  },
  {
    ...
    validate: (params: any) => {
      ...
      if (m === "create") {
        const itemSchema = z.object({
          collectionName: z.string().describe("Variable collection name"),
