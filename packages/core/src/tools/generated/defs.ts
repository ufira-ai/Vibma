      ...
      if (m === "create") {
        const schemas: Record<string, z.ZodTypeAny> = {
          "component": z.object({
            ...
            strokeWeight: S.token.optional().describe("Stroke weight (default: 1)"),
      ...
      if (m === "create") {
        const schemas: Record<string, z.ZodTypeAny> = {
          "frame": z.object({
            ...
            bottomRightRadius: S.token.optional(),
            bottomLeftRadius: S.token.optional(),
            opacity: S.token.optional().describe("Opacity 0-1 (number) or variable name (string)"),
          ...
          "auto_layout": z.object({
            ...
            itemSpacing: S.token.optional().describe("Gap between children (number) or variable name (string)"),
