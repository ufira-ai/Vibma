...
Vibma exposes **12 endpoint tools** instead of dozens of standalone tools. Each endpoint groups related operations behind a single tool with a `method` parameter — similar to a REST resource.
...
- **Reduces tool count** — 12 endpoints cover 59 methods
